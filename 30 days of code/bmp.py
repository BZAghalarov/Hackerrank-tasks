"""A module for dealin with bitmap image files"""
...
def write_grayscale(filename, pixels):
    ...
    Args:
        ...
        pixels: A rectangular image stored as a seqeunce of rows.
    ...
    with open(filename, 'wb') as bmp:
        ...
        bmp.write(b'\x00\x00\x00\x00')  #littele-endian integer.Zero place-holder for now

        bmp.write(b'\x00\x00')  # unusued 16-bit integer shoul be zero
        bmp.write(b'\x00\x00')  # unusued 16-bit integer shoul be zero
        ...
        # Image Header
        bmp.write(b'\x28\x00\x00\x00')  # Image header size in bytes 40decimal
...
def _int32_to_bytes(i):
    """ Convert aninteger to four bytes in littel-endian format."""
